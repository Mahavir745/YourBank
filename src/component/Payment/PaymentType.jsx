  ...
  return (
    <>
      ...
      background:"#8b8989bb"
        ...
        <div className='w-[600px] min-h-[200px] relative border rounded-b-xl rounded-t-md border-gray-300 p-4 bg-white popup' ref={closeRef}>
          ...
          <form action="#" className='w-[580px]' onSubmit={(e)=>HandlePayForm(e)}>
