...
const Card = () => {
  ...
  return (
    <>
      <div className='flex justify-center gap-4 h-full items-center relative  top-0 w-full '>
        <div className='flex items-center justify-center absolute bg-white top-4 right-10 p-1 cursor-pointer'>
      ...
      { tabs && <div className='flex items-center flex-col justify-center absolute z-40 top-14 right-12 bg-gray-100 w-[180px] font-bold rounded-md cursor-pointer p-2' ref={menuRef}>
        ...
        <div className='w-[500px] min-h-[280px] relative border rounded-xl border-gray-300 p-4 flex flex-col justify-center bg-gradient-to-bl to-sky-400 from-slate-200 popup'>
        ...
        <div className='w-[500px] min-h-[280px] relative border rounded-xl border-gray-300 p-4 flex flex-col justify-center bg-gradient-to-bl to-sky-200 from-slate-50 popup'>
      ...
      <div className=''>
        <div className=' w-[700px] min-h-[500px] m-auto p-4'>
          ...
          <ul className=' ml-6 flex gap-4 justify-center mt-20'>
            <li className='font-bold p-4 rounded-md bg-gray-800 text-white w-[300px] h-[240px] shadow-md shadow-blue-400 flex flex-col justify-center items-center gap-5 hover:scale-95 relative top-10 flex-shrink-0' style={{
              transition: "all .3s linear"
            }}>
