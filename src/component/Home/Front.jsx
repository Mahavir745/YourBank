...
const Front = () => {
  return (
    <div>
      <div className='w-full p-2 mt-10 m-auto h-full flex flex-col lg:flex-row items-center justify-around gap-20'>
        ...
        <div className='rounded-xl overflow-hidden w-full lg:w-[700px] h-[400px] sm:h-[600px] relative flex justify-center items-center flex-col'>
          ...
          <h1 className=' z-20 text-6xl sm:text-8xl sm:top-40 sm:left-24 text-white font-bold'
            style={{
          ...
          <ul className='flex gap-4 mt-10'>
            <li className='sm:w-34 sm:h-34 shadow-xl relative top-10 flex justify-center items-center hover:scale-95' style={{
            transition:"all .3s linear"
          }}>
              <AiFillSafetyCertificate className='text-7xl sm:text-8xl text-violet-500'/></li>
            <li className='sm:w-34 sm:h-34 shadow-xl flex justify-center items-center hover:scale-95' style={{
            transition:"all .3s linear"
          }}>
